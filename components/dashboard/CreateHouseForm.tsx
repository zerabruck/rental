  ...
  return (
    <div className=''>
        <form onSubmit={submitHandler}>
            ...
            <div className='flex flex-wrap gap-5 items-center '>

                {
                    pictures.map(picture =>{
                        return (
                            <div className='w-[4rem] h-[4rem] relative' onClick={() =>handlePicturesDelete(picture)}>
            ...
            <div className="h-[.5px] w-full border border-[#EEEEEE] mt-5 "></div>
            <div className='flex justify-between mt-5 px-12  max-sm:px-2'>
                <button type='submit'  className="bg-primary w-fit text-white px-4 py-2 rounded-[3rem] cursor-pointer">Submit</button>
                <button  className="bg-red-500 w-fit text-white px-4 py-2 rounded-[3rem] cursor-pointer">Cancel</button>
            </div>
        </form>
    </div>
  )
